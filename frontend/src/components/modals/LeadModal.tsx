...
const LeadModal: React.FC<LeadModalProps> = ({ isOpen, onClose, lead }) => {
  ...
  if (!lead && (role === 'relationship_mgr' || role === 'financial_manager')) {
    ...
    if (user) {
      ...
      console.log('✅ Auto-assignment applied:', { assigned_to: userId, team_id: user.team_id, finalData });
    } else {
